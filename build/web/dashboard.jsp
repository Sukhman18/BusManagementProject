<%-- 
    Document   : dashboard
    Created on : Dec 2, 2018, 7:39:24 PM
    Author     : Sukhman
--%>
...
<html lang="en">
    ...
    <body background="images/eng1.jpg" style="background-size: auto;">
        ...
        <div class="nav">
            <a class="a" href="#" onclick = "home()">HOME</a>
            <%
                ...
                if(a.equals("admin"))
                    {%>
                    <a class="b" href="adminpanel.jsp" onclick = "">ADMIN PANEL</a>
                    <%}
                    else{%>
            <a class="b" href="Student_Info.jsp" >PROFILE</a>
            <a class="c" href="bus_info.jsp" >BUS INFO</a>
              
            <a class="b" href="Payment.html" onclick = "contact()">FEES PAYMENT</a>
            <a class="a" href="Feedback.html" onclick = "">FEEDBACK</a>
            <%}
}%>
